package com.berry.uaa.security.filter;
...
import com.berry.uaa.module.dto.UserInfoDTO;
...
public class TokenProvider {
    ...
    private static final String SECRET = "com.berry.uaa.secret";
    ...
    Authentication getAuthentication(String jwt) throws UnsupportedEncodingException {
        ...
        principal.setUserId(claimMap.get(USER_ID_KEY).asString());
